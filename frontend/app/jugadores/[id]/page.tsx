  ...
  return (
    <main className="player-page">
      <header className="site-header">
        ...
        <nav aria-label="Navegación principal"><a href="/clubes">Clubes</a><a href="/jugadores">Jugadores</a><a href="#historial">Historial</a><span className="language-badge">ES</span></nav>
      </header>
